...
# 自定义SIMPLEUI的Logo
SIMPLEUI_LOGO = 'https://www.brampton.ca/EN/residents/transit/About-Us/PublishingImages/eBus%20Partner%20Logos/eBus.png'
...
SIMPLEUI_CONFIG = {
    ...
    #     }]
            ...
            'name': 'Grid Impact Analysis',
            'url': '',
            'icon': 'fa-solid fa-tower-observation'
        }, {
            'name': 'Mix-Fleet Optimazation',
            'url': '',
