...
def build_chart_panel():
    return html.Div(
        ...
        children=[
            generate_section_banner("Bus Analysis Charts"),
...
def update_graph(tabs):
    ...
    layout = Layout(
        ...
        font={"color": "darkgray",
              "size": 15},
        xaxis=dict(
            showline=False, showgrid=False, zeroline=False, titlefont={"color": "darkgray"}
        ),
        yaxis=dict(
            showgrid=False, showline=False, zeroline=False, titlefont={"color": "darkgray"}
        ),
